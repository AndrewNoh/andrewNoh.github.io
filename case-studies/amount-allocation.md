...
image: /assets/images/amount-allocation.svg
---
...
<article class="case-study">
  ...
  <section class="case-study-section" aria-labelledby="case-title">
  ...
  <section class="case-study-section" aria-labelledby="risk-title">
  ...
  <section class="case-study-section" aria-labelledby="architecture-title">
    ...
    ![수납·결제 금액 통합 분배 구조]({{ '/assets/images/amount-allocation.svg' | relative_url }})
  ...
  <section class="case-study-section" aria-labelledby="context-title">
  ...
  <section class="case-study-section" aria-labelledby="assembler-title">
  ...
  <section class="case-study-section" aria-labelledby="journey-title">
  ...
  <section class="case-study-section" aria-labelledby="priority-title">
  ...
  <section class="case-study-section" aria-labelledby="allocator-title">
  ...
  <section class="case-study-section" aria-labelledby="return-title">
  ...
  <section class="case-study-section" aria-labelledby="tax-title">
  ...
  <section class="case-study-section" aria-labelledby="fee-title">
  ...
  <section class="case-study-section" aria-labelledby="state-title">
  ...
  <section class="case-study-section" aria-labelledby="validation-title">
